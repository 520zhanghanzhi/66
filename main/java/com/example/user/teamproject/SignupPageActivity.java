...
public class SignupPageActivity extends AppCompatActivity {
    Button signup;
    EditText signupUsername,signupUUINFO;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // signupPassword = findViewById(R.id.signupPassword);
        signupUUINFO = findViewById(R.id.signupUUINFO);
            ...
            signup.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                   ...
                   // String passwordCol = signupPassword.getText().toString();
                    String UUINFO = signupUUINFO.getText().toString();;
        ...
        ss.setSpan(clickableSpan, 0, 1, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
